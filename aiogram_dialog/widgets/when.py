...
from ..api.protocols import ActiveDialogManager

Predicate = Callable[[Dict, "Whenable", ActiveDialogManager], bool]
WhenCondition = Union[str, MagicFilter, Predicate, None]


def new_when_field(fieldname: str) -> Predicate:
    def when_field(
            data: Dict, widget: "Whenable", manager: ActiveDialogManager,
    ) -> bool:
...
def true(data: Dict, widget: "Whenable", manager: ActiveDialogManager):
    return True
